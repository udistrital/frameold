...
class funcion_bannerFlotante extends funcionGeneral {
    ...
    function mostrarbannerFlotante() {
        ...
        ?>
        <link href="<?echo $this->configuracion["host"].$this->configuracion["site"].$this->configuracion["bloques"];?>/banner/css/estiloBanner.css" rel="stylesheet" type="text/css" />  
        <script type="text/javascript" src="<?echo $this->configuracion["host"].$this->configuracion["site"].$this->configuracion["bloques"];?>/banner/js/jquery.js"></script>
